...
(plus `AZURE_OPENAI_API_KEY` or Azure CLI authentication) before starting the Functions host.
"""
...
def _create_agent() -> Any:
    ...
    # Use ManagedIdentityCredential when deployed (with client_id), DefaultAzureCredential for local dev
